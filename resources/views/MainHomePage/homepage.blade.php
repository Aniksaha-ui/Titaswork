...
<div class="flexslider">
   	<div class="flex-viewport" style="overflow: hidden; position: relative;">
   		<ul class="slides" style="width: 100%; align-content: center; -webkit-transition: 0.6s; transition: 0.6s; -webkit-transform: translate3d(-5032px, 0, 0);">
   				<li class="" style="width:100%; float: left; display: block;">
    	    	<img src="{{asset('cicohomepage/images/cicotech.jpg')}}" style="max-height: 455px; width: 120%;" alt=""/>
    	    	
    			<p style="text-align: center;">স্বাধীনতার মাসে সিকো নিয়ে এলো আরও একটি অফার । পূর্বের অফারতো আছেই। সুতরাং আমাদের ডিলার পয়েন্টে আসুন এবং আপনারাও আপনাদের Part by Part অফারটি বুঝে নিন, বেশী বেশী সিকো পন্য ক্রয় করে। সিকো আপনাদের সাথেই আছে।আমাদের বিশ্বাস ডিলার পয়েন্টেও আপনারা বাড়তি সুবিধা পাবেন ।</p>
    			</li>
    		<li class="clone" style="width:100%; float: left; display: block;">
    	    	<img src="{{asset('cicohomepage/images/slider4.jpg')}}" style="max-height: 455px; width: 120%;" alt=""/>
    	    	
    			<p style="text-align: center;">সফল ভাবে রিটেইলার কনফারেন্স শেষ করার পর আমরা আরও আশাবাদী, আমাদের ভবিষ্যত নিয়ে। তবে বগুড়ার মানুষের ভালবাসাই আমরা সত্যি অভিভূত । ধন্যবাদ সবাইকে।</p>
    		</li>
       	@foreach($discounted_product as $discounted_product)
    		<li class="clone" style="width:100%; float: left; display: block;">
    	    	<img src="{{$discounted_product->p_image}}" style="max-height: 455px; width: 120%;" alt=""/>

    			<p style="text-align: center;">Product Name:{{$discounted_product->p_name}}</p>
    			<p style="text-align: center;">Model Name:{{$discounted_product->m_name}}</p>
    			<p style="text-align: center;">Discount:{{$discounted_product->discount_in_percentage}}%</p>
...
<div class="section group">
	...
	<div class="col_1_of_5 span_1_of_5">
		<div class="grid-imgs">
			<a href="{{URL('catagorywiseproduct/'.$catagory->id)}}"><img src="{{$catagory->c_image}}" alt=""/></a> 
		</div>
		<p style="text-align: center;">{{$catagory->c_name}}</p>
...
<div class="section group">
	...
	<div class="col_1_of_5 span_1_of_5">
		...
		<div class="grid-img">
				<a href=""><img src="{{$popularproduct->p_image}}" alt=""/></a> 
		</div>
