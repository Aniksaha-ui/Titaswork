       ...
       <table class="table table-bordered" id="datatable" style="background-color: white;">
          ...
          @foreach($view as $view)
                  <tr class="rem1">
                        ...
                        <td class="invert" style="padding-top: 22px;padding-bottom: 10px; font-family: sans-serif;" id="amount{{$view->id}}">{{$view->d_price}}</td>
          ...
          @endforeach
                    ...
                    <tr><td></td>
                        ...
                        <td></td>
                        <td></td>
                        <td class="invert-closeb" style="padding-top: 15px;padding-bottom: 10px; font-family: sans-serif;">Grand Total</td>
